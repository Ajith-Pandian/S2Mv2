...
import static com.example.wowconnect.domain.Constants.IS_LIKED;
import static com.example.wowconnect.domain.Constants.KEY_ACTIVITIES;
import static com.example.wowconnect.domain.Constants.KEY_BULLETIN_BOARD;
import static com.example.wowconnect.domain.Constants.KEY_ICON;
import static com.example.wowconnect.domain.Constants.KEY_ID;
import static com.example.wowconnect.domain.Constants.KEY_LIKES_COUNT;
...
import static com.example.wowconnect.domain.Constants.KEY_TIMESTAMP;
...
import static com.example.wowconnect.domain.Constants.ROLE_TEACHER;
import static com.example.wowconnect.domain.Constants.TYPE_BULLETIN;
