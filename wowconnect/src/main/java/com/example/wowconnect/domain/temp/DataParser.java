package com.example.wowconnect.domain.temp;
...
import static com.example.wowconnect.domain.Constants.KEY_BODY;
import static com.example.wowconnect.domain.Constants.KEY_CLASS_NAME;
import static com.example.wowconnect.domain.Constants.KEY_ID;
import static com.example.wowconnect.domain.Constants.KEY_MILESTONE_ID;
import static com.example.wowconnect.domain.Constants.KEY_MILESTONE_NAME;
import static com.example.wowconnect.domain.Constants.KEY_MILES_COMPLETION_COUNT;
import static com.example.wowconnect.domain.Constants.KEY_MILES_COUNT;
import static com.example.wowconnect.domain.Constants.KEY_SECTION_NAME;
import static com.example.wowconnect.domain.Constants.KEY_STUDENT_COUNT;
import static com.example.wowconnect.domain.Constants.KEY_TEACHER_ID;
import static com.example.wowconnect.domain.Constants.KEY_TEACHER_NAME;
import static com.example.wowconnect.domain.Constants.KEY_TITLE;
