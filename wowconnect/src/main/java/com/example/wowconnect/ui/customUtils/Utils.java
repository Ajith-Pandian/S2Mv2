...
import com.example.wowconnect.S2MApplication;
...
public class Utils {
    ...
    public int[] getCenterPoint(Activity activity) {
        ...
        int[] points = {(int) centerX, (int) centerY};
        return points;
    }
    ...
    private void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        final ImageView expandedImageView = null;// = (ImageView) findViewById(R.id.expanded_image);
    ...
    public Bitmap getRoundedCornerBitmap(Context context, Bitmap bitmap, int cornerDips, int borderDips) {
        ...
        int borderSizePx = 0;
        if (context != null)
            borderSizePx = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, (float) borderDips,
