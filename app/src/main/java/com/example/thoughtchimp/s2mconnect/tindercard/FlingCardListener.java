...
import com.example.thoughtchimp.s2mconnect.HomeFragment;
    ...
    public boolean onTouch(View view, MotionEvent event) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                //homeFragment.removeBackground();
                /*Log.d(TAG, "cards_count" +cards_count);
                if(cards_count==3)
                { Log.d(TAG, "cards_count last two card");}
                if(cards_count==2)
                { Log.d(TAG, "cards_count last one card");}
                else if(cards_count==1)
                {Log.d(TAG, "cards_count last card" );}*/
